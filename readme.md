...
```
pnpm add express bcryptjs cors cookie-parser http-status-codes jsonwebtoken
pnpm add -D @types/express @types/cors @types/cookie-parser @types/jsonwebtoken
```
* config/index.ts setup: create a config file into src and a index.ts file into config file.
```
